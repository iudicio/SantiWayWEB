...
class NotificationConsumer(AsyncWebsocketConsumer):
    ...
    async def connect(self):
        ...
        logger.info(f"WebSocket connected: user={user.username}, group={self.user_group_name}")
    ...
    async def disconnect(self, close_code):
        ...
        if self.user_group_name:
            ...
            logger.info(f"WebSocket disconnected: group={self.user_group_name}, code={close_code}")
